class GSEnhancedUI {
    ...
    setupResellerList() {
        ...
        // Mevcut formları bir div içine alalım
        const directPaymentSection = document.createElement('div');
        directPaymentSection.className = 'payment-section direct-payment';
        
        // Mevcut formları yeni container'a taşıyalım
        const forms = paymentContainer.querySelectorAll('form');
        forms.forEach(form => directPaymentSection.appendChild(form.cloneNode(true)));
    
        // Reseller section oluşturalım
        const resellerSection = document.createElement('div');
        resellerSection.className = 'payment-section reseller-payment';
                        ...
                        <div class="reseller-grid">
                            <div class="reseller-card">
                                <div class="reseller-info">
                                    <a href="profile.php?id=1" class="reseller-name">Sigma</a>
                                    <div class="payment-methods">Crypto, PayPal, CashApp</div>
                                    <div class="price">24 USD</div>
                                </div>
                                <a href="viewtopic.php?id=23385" class="button">Purchase</a>
                            </div>
                            <div class="reseller-card">
                                <div class="reseller-info">
                                    <a href="profile.php?id=1" class="reseller-name">Kent Game</a>
                                    <div class="payment-methods">花呗，微信，支付宝，QQ红包</div>
                                    <div class="price">135 RMB</div>
                                </div>
                                <a href="viewtopic.php?id=17427" class="button">Purchase</a>
                            </div>
                            <div class="reseller-card">
                                <div class="reseller-info">
                                    <a href="profile.php?id=1" class="reseller-name">阿泽服务</a>
                                    <div class="payment-methods">支付宝/微信/QQ/QIWI/淘宝/PayPal</div>
                                    <div class="price">135 RMB</div>
                                </div>
                                <a href="viewtopic.php?id=17435" class="button">Purchase</a>
                            </div>
                            <div class="reseller-card">
                                <div class="reseller-info">
                                    <a href="profile.php?id=1" class="reseller-name">Insta Resell</a>
                                    <div class="payment-methods">PayPal, Bank, Card, Crypto, PSC, Alipay, Pix</div>
                                </div>
                                <a href="viewtopic.php?id=25671" class="button">Purchase</a>
                            </div>
                        </div>
        ...
        // Clear existing content and add new sections
        paymentContainer.innerHTML = '';
        paymentContainer.appendChild(directPaymentSection);
