class GSEnhancedUI {
    ...
    setupResellerList() {
        const extendGameSenseBox = document.querySelector('.blockform .box #payment-container');
        if (!extendGameSenseBox || !window.location.href.includes('payment.php')) return;
                    ...
                    <div class="fakeform">
                        ...
                        <table class="reseller-table">
                            ...
                            <tr>
                                ...
                                <td><a href="viewtopic.php?id=23385" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">Kent Game</a></td>
                                <td>花呗，微信，支付宝，QQ红包 (135 RMB)</td>
                                <td><a href="viewtopic.php?id=17427" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">阿泽服务</a></td>
                                <td>支付宝/微信/QQ/QIWI/淘宝/PayPal (135 RMB)</td>
                                <td><a href="viewtopic.php?id=17435" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">Insta Resell</a></td>
                                <td>PayPal, Bank, Card, Crypto, PSC, Alipay, Pix</td>
                                <td><a href="viewtopic.php?id=25671" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">Flux HvH</a></td>
                                <td>支付宝，微信 (中国支付方式)</td>
                                <td><a href="viewtopic.php?id=45009" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">Samo's Service</a></td>
                                <td>PayPal, Giropay, TF2, Crypto, Skrill</td>
                                <td><a href="viewtopic.php?id=43045" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">Keys & Skins</a></td>
                                <td>TF2 Keys, PayPal, Skins, BTC, ETH</td>
                                <td><a href="viewtopic.php?id=17477" class="purchase-btn">Purchase</a></td>
                            </tr>
                            <tr>
                                <td><a href="profile.php?id=1">Online Buy</a></td>
                                <td>Cards RU/EU/KZ/UA/ASIA, All Crypto</td>
                                <td><a href="viewtopic.php?id=27735" class="purchase-btn">Purchase</a></td>
                            </tr>
                        </table>
        ...
        extendGameSenseBox.appendChild(resellerSection);
    }
