class GSEnhancedUI {
    ...
    setupResellerList() {
        ...
        // Ana container'ı flex yapacağız
        paymentContainer.style.display = 'flex';
        paymentContainer.style.gap = '20px';
        paymentContainer.style.justifyContent = 'center';
    
        // Mevcut form elementini wrap edelim
        const directPaymentSection = document.createElement('div');
        directPaymentSection.className = 'payment-section';
        directPaymentSection.style.flex = '1';
        directPaymentSection.style.maxWidth = '500px';
        ...
        resellerSection.className = 'payment-section';
        resellerSection.style.flex = '1';
        resellerSection.style.maxWidth = '500px';
